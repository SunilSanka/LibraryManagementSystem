...
@FeignClient(name="library-users", url="${LIBRARY_USERS_SERVICE_HOST:http://localhost}:8100")
//@FeignClient(name="library-users", url="${LIBRARY_USERS_URI:http://localhost}:8100")
